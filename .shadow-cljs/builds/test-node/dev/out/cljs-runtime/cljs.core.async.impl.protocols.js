...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31667 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31667(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31668 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31668(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31669 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31669(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31670 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31670(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31671 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31671(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31672 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31672(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_31673 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_31673(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31674 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31674(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31675 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31675(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31676 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31676(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31677 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31677(b);
}
});
