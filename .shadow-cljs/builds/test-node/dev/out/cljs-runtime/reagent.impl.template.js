...
var G__31905 = o;
goog.object.set(G__31905,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__31908 = o;
goog.object.set(G__31908,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__31981__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__31981__delegate.call(this,args);};
G__31981.cljs$lang$maxFixedArity = 0;
G__31981.cljs$lang$applyTo = (function (arglist__31983){
var args = cljs.core.seq(arglist__31983);
return G__31981__delegate(args);
});
...
var G__31909 = props;
var G__31909__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31909,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31909);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31909__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__31909__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__31910 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31910,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__31910;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__31911){
var map__31912 = p__31911;
var map__31912__$1 = cljs.core.__destructure_map(map__31912);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31912__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__31917_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__31917_SHARP_);
}));
} else {
return null;
}
...
var vec__31921 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31921,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31921,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31921,(2),null);
...
var temp__5757__auto___31994 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___31994 == null)){
} else {
var key_31995 = temp__5757__auto___31994;
...
var temp__5757__auto___31997 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___31997 == null)){
} else {
var key_31998 = temp__5757__auto___31997;
...
var G__31925 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__31925) : reagent.impl.template.as_element.call(null,G__31925));
} else {
var temp__5757__auto___32000 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___32000 == null)){
} else {
var key_32001 = temp__5757__auto___32000;
...
var G__31927 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__31927)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__31927)){
return x;
} else {
...
var G__32004 = (i__4819__auto___32003 + (1));
i__4819__auto___32003 = G__32004;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq31928){
var G__31929 = cljs.core.first(seq31928);
var seq31928__$1 = cljs.core.next(seq31928);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31929,seq31928__$1);
}));
...
break;
default:
var G__32010 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__32010;
continue;
...
var ctx = ({});
var vec__31966 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31966,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31966,(1),null);
...
var G__31971 = (cljs.core.count(argv) - first_child);
switch (G__31971) {
case (0):
